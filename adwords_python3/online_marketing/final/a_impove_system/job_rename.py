...
def Rename (connect, path_data, list_customer_id, date):
	...
	if list_camp_remove_unmap != [] or list_camp_update != []:
		...
		merge_data_manual_mapping.merger_data_manual_mapping(connect, list_camp_remove_unmap, list_plan_remove_unmap, list_camp_remove_unmap, list_plan_update, list_plan_insert_un_map)
