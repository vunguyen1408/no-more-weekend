...
list_path = ['C:\\Users\\CPU10145-local\\Desktop\\Python Envirement\\Data\Date\\2016-01-01\\ads_creatives_audit_content_2016-01-01.json']

def get_content_label_list_file(list_path_file):
    """
...
# result, label = get_content_label_list_file(list_path)
# for row in result:
#     print (row)
# print ("=======================================================================")
# for row in label:
...
def get_content_label_date(path, date_ = None, to_date_ = '0001-01-01'):
    """
    ...
    list_result, label_image = get_content_label_list_file(list_file)
