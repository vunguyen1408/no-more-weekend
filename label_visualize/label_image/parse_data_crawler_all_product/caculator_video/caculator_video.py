# package
import get_content_video as get_content_video
...
def getData(path_file_content):
    ...
    lable_unique = []
    list_json = []
    list_result, label_image, number = get_content_video.get_content_label_file(path_file_content)
...
def create_excel_all_product(path_in_json, path_out):
    ...
    for folder in list_folder:
        ...
        if os.path.exists(file_json_content):
            ...
            #================ Write file percent ==================
            file_percent = os.path.join(path_out, product_id + '/' + product_id + '_video.csv')
            ...
            file_name = os.path.join(path_out, product_id + '/' + product_id + '_video_relationship.csv')
