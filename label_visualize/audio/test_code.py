...
a = subprocess.call(["ffprobe", file_audio[0:-5] + '.16.flac', "-show_streams| grep", "sample_rate"], shell=True) # "-show_streams| grep", "duration"])
# a = subprocess.check_output(["ffprobe", file_audio[0:-5] + '.16.flac', "-show_streams| grep", "sample_rate"])
